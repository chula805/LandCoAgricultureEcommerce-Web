   ...
   <section class="checkout-orders">
      ...
      <form action="" method="POST">
         ...
         <div class="display-orders">
            ...
            if ($select_cart->rowCount() > 0) {
               while ($fetch_cart = $select_cart->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  ?>
                  <p> <?= $fetch_cart['name']; ?>
                     <span>(<?= 'LKR' . $fetch_cart['price'] . '/- x ' . $fetch_cart['quantity']; ?>)</span> </p>
                  <?php
               }
            } else {
            ...
            <div class="grand-total">Grand Total : <span>LKR.<?= $grand_total; ?>/-</span></div>
         </div>
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               <span>ZIP CODE :</span>
               <input type="number" min="0" name="pin_code" min="0" max="999999"
