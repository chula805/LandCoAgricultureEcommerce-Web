...
if (isset($_POST['add_product'])) {
   ...
   $main_category_id = filter_var($_POST['main_category_id'], FILTER_VALIDATE_INT);
   $sub_category_id = filter_var($_POST['sub_category_id'], FILTER_VALIDATE_INT);
   ...
   if ($select_products->rowCount() > 0) {
      ...
      $insert_products = $conn->prepare("INSERT INTO `products` (name, details, price, main_category_id, sub_category_id, image_01, image_02, image_03) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
      $insert_products->execute([$name, $details, $price, $main_category_id, $sub_category_id, $image_01, $image_02, $image_03]);
   ...
   <section class="add-products">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         <div class="flex">
            ...
            <div class="inputBox">
               <span>Main Category (required)</span>
            ...
            <div class="inputBox">
               <span>Subcategory (required)</span>
               <select name="sub_category_id" class="box" required>
                  <option value="" disabled selected>Select Subcategory</option>
                  <?php
                  $subcategories = $conn->prepare("SELECT * FROM `subcategories`");
         ...
         if ($select_products->rowCount() > 0) {
            while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
               ...
               <div class="box">
                  ...
                  <div class="main_category_id"><span>Main Category ID:<?= $fetch_products['main_category_id']; ?></span>
                  </div>
                  <div class="sub_category_id"> <span>Sub Category ID: <?= $fetch_products['sub_category_id']; ?></span></div>
                  <div class="flex-btn">
